...
INSERT IGNORE INTO inventory (material_id, warehouse, quantity, locked_quantity) VALUES
(1, '主仓库', 200, 0),
(2, '主仓库', 150, 0),
(3, '主仓库', 500, 0),
(4, '主仓库', 3000, 0),
...
INSERT IGNORE INTO inventory_transaction (transaction_no, material_id, transaction_type, quantity, balance_after, remark) VALUES
('TX-20260727-0001', 1, 'RECEIVE', 200, 200, '初始入库'),
('TX-20260727-0002', 2, 'RECEIVE', 150, 150, '初始入库'),
('TX-20260727-0003', 3, 'RECEIVE', 500, 500, '初始入库'),
('TX-20260727-0004', 4, 'RECEIVE', 3000, 3000, '初始入库'),
('TX-20260727-0005', 5, 'RECEIVE', 2000, 2000, '初始入库'),
('TX-20260727-0006', 8, 'RECEIVE', 500, 500, '初始入库'),
('TX-20260727-0007', 9, 'RECEIVE', 300, 300, '初始入库'),
('TX-20260727-0008', 10, 'RECEIVE', 15, 15, '初始入库');
